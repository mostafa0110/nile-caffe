...
const MenuPage = () => {
  ...
  const items = [
    {
      imageUrl: 'https://bakerbynature.com/wp-content/uploads/2023/08/Easy-Chocolate-Mousse-Baker-by-Nature-12617-1-500x500.jpg',
    ...
    {
      imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRyyYOkdhPnpnYvLOKiyYu1d0tK4kExFqYedg&s',
      name: 'Tiramisu',
  ...
  return (
    <div className="bg-zinc-900 text-white  p-28 pt-40  flex flex-col   items-center">
      ...
      <div className=" mx-auto mt-10 px-4 py-8">
        <h1 className="text-3xl font-bold text-center text-white mb-4">Deserts</h1>
