...
const ContactUs = () => {
  return (
    <div className="bg-black text-white p-6 md:p-10 flex flex-col items-center">
  ...
  <div className="space-y-4">
    <p className="flex items-center">
      <FontAwesomeIcon icon={faEnvelope} className="w-6 h-6 text-green-500 mr-2" /> 
      <a href="mailto:elvlfy9@Gmail.com" className="text-green-500">elvlfy9@Gmail.com</a>
    </p>
    <p className="flex items-center">
      <FontAwesomeIcon icon={faPaperPlane} className="w-6 h-6 text-green-500 mr-2" />
      <a href="https://t.me/mymeal" className="text-green-500">@adhamalfy</a>
    </p>
    <p className="flex items-center">
      <FontAwesomeIcon icon={faPhone} className="w-6 h-6 text-green-500 mr-2" />
      <a href="tel:+79581332415" className="text-green-500">01114814871</a>
    </p>
  </div>
</div>
